...
export class SidenavRoutesListComponent implements OnInit {
  ...
  readonly BIMSWARMRoute: SideNavRoute = {
    caption: 'BIMSWARM',
    icon: 'assets/img/custom/logo/logo.svg',
    route: undefined,
  ...
  readonly RoboSWARMRoute: SideNavRoute = {
    caption: 'RoboSWARM',
    icon: 'assets/img/custom/roboswarm.svg',
    route: undefined,
    showInSideNav$: of(true),
    effect: () => {
      this.openBIMSWARM();
  ...
  openBIMSWARM() {
    window.open('https://bimswarm.online', '_blank', 'noopener');
  }
