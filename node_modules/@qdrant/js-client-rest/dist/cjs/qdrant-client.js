...
const maybe_1 = require("@sevinf/maybe");
...
class QdrantClient {
     ...
     */
    async scroll(collection_name, { shard_key, filter, consistency, limit = 10, offset, with_payload = true, with_vector = false, } = {}) {
     ...
     * @returns Operation result
     */
    async setPayload(collection_name, { payload, points, filter, shard_key, ordering, wait = true, }) {
     ...
     * @returns Operation result
     */
    async overwritePayload(collection_name, { ordering, payload, points, filter, wait = true, }) {
    ...
    async recreateCollection(collection_name, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, sharding_method, wal_config, write_consistency_factor, sparse_vectors, }) {
        (0, maybe_1.maybe)(await this._openApiClient.collections.deleteCollection({
            collection_name,
            timeout,
        }))
            .get('ok')
        ...
        return (0, maybe_1.maybe)(response).orThrow('Create collection returned empty');
    }
    /**
    ...
    async createPayloadIndex(collection_name, { wait, ordering, field_name, field_schema, }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Create field index returned empty');
    }
    /**
    ...
    async deletePayloadIndex(collection_name, field_name, { wait = true, ordering } = {}) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Delete field index returned empty');
    }
    /**
    ...
    async listSnapshots(collection_name) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('List snapshots API returned empty');
    }
    /**
    ...
    async createSnapshot(collection_name, args) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orNull();
    }
    /**
    ...
    async deleteSnapshot(collection_name, snapshot_name, args) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Delete snapshot API returned empty');
    }
    /**
    ...
    async listFullSnapshots() {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('List full snapshots API returned empty');
    }
    /**
    ...
    async deleteFullSnapshot(snapshot_name, args) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Delete full snapshot API returned empty');
    }
    /**
     ...
     */
    async recoverSnapshot(collection_name, { location, priority }) {
        const response = await this._openApiClient.snapshots.recoverFromSnapshot({ collection_name, location, priority });
        return (0, maybe_1.maybe)(response.data.result).orThrow('Recover from snapshot API returned empty');
    }
    /**
    ...
    async lockStorage(reason) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Lock storage returned empty');
    }
    /**
    ...
    async unlockStorage() {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Post locks returned empty');
    }
    /**
    ...
    async getLocks() {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Get locks returned empty');
    }
    /**
     * Batch update points
    ...
    async batchUpdate(collection_name, { wait = true, ordering, ...operations }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Batch update returned empty');
    }
    /**
    ...
    async recoverShardFromSnapshot(collection_name, shard_id, { wait = true, ...shard_snapshot_recover }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Recover shard from snapshot returned empty');
    }
    /**
    ...
    async listShardSnapshots(collection_name, shard_id) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('List shard snapshots returned empty');
    }
    /**
    ...
    async createShardSnapshot(collection_name, shard_id, { wait = true }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Create shard snapshot returned empty');
    }
    /**
    ...
    async createShardKey(collection_name, { shard_key, shards_number, replication_factor, placement, timeout, }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Create shard key returned empty');
    }
    /**
     * Delete shard key
     * @param collection_name Name of the collection
    ...
    async discoverPoints(collection_name, { consistency, timeout, shard_key, target, context, params, limit, offset, with_payload, with_vector, using, lookup_from, }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Discover points returned empty');
    }
    /**
    ...
    async discoverBatchPoints(collection_name, { consistency, timeout, searches, }) {
        ...
        return (0, maybe_1.maybe)(response.data.result).orThrow('Discover batch points returned empty');
    }
}
