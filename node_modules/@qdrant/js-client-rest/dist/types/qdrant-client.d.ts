import { OpenApiClient } from './api-client.js';
...
export declare class QdrantClient {
     ...
     */
    scroll(collection_name: string, { shard_key, filter, consistency, limit, offset, with_payload, with_vector, }?: SchemaFor<'ScrollRequest'> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        points: {
            id: string | number;
     ...
     */
    count(collection_name: string, { shard_key, filter, exact }?: SchemaFor<'CountRequest'>): Promise<{
        count: number;
    }>;
    /**
     ...
     */
    retrieve(collection_name: string, { shard_key, ids, with_payload, with_vector, consistency, }: SchemaFor<'PointRequest'> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        id: string | number;
        payload?: Record<string, unknown> | {
     ...
     * @returns Operation result
     */
    setPayload(collection_name: string, { payload, points, filter, shard_key, ordering, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
     ...
     * @returns Operation result
     */
    overwritePayload(collection_name: string, { ordering, payload, points, filter, wait, }: {
        wait?: boolean;
        ordering?: SchemaFor<'WriteOrdering'>;
    } & SchemaFor<'SetPayload'>): Promise<{
        operation_id?: number | null | undefined;
     ...
     *         If timeout is reached, request will return with service error.
     */
    createCollection(collection_name: string, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, sharding_method, wal_config, write_consistency_factor, sparse_vectors, }: {
        timeout?: number;
     ...
     *         If timeout is reached, request will return with service error.
     */
    recreateCollection(collection_name: string, { timeout, vectors, hnsw_config, init_from, on_disk_payload, optimizers_config, quantization_config, replication_factor, shard_number, sharding_method, wal_config, write_consistency_factor, sparse_vectors, }: {
        timeout?: number;
     ...
     */
    recoverSnapshot(collection_name: string, { location, priority }: SchemaFor<'SnapshotRecover'>): Promise<boolean>;
    /**
