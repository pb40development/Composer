...
function axiosMultipleTries(axiosCallCreator_1) {
    return __awaiter(this, arguments, void 0, function* (axiosCallCreator, retriesLeft = environment_1.NUMBER_OF_AXIOS_RETRIES) {
        try {
