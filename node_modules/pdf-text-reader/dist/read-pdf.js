...
exports.parsePageItems = exports.parsePage = exports.combinePagesIntoSingleString = exports.readPdfText = exports.readPdfPages = void 0;
 ...
 */
async function readPdfPages({ data, filePath, password, pathToPdfJsDistNodeModule, progressCallback, url, options, }) {
...
exports.readPdfPages = readPdfPages;
/** Reads a PDF into a single string. */
async function readPdfText(params) {
...
function combinePagesIntoSingleString(pages) {
    return pages
        .map((page) => page.lines)
        .flat()
        .join('\n');
}
exports.combinePagesIntoSingleString = combinePagesIntoSingleString;
