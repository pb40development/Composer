        ...
        return tslib_1.__generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 11:
                    ...
                    return [4 /*yield*/, (0, remote_loader_1.remoteLoader)(legacySettings, analytics.integrations, mergedSettings, options, tsubMiddleware, pluginSources).catch(function () { return []; })];
                case 12:
            ...
            switch (_m.label) {
                case 0:
                    ...
                    if (options.initialPageview) {
                        ...
                        preInitBuffer.push(new buffer_1.PreInitMethodCall('page', []));
                    }
                ...
                case 5:
                    ...
                    analytics = new analytics_1.Analytics(settings, options);
                    ...
                    stats_1.Stats.initRemoteMetrics(tslib_1.__assign(tslib_1.__assign({}, legacySettings.metrics), { host: (_g = segmentLoadOptions === null || segmentLoadOptions === void 0 ? void 0 : segmentLoadOptions.apiHost) !== null && _g !== void 0 ? _g : (_h = legacySettings.metrics) === null || _h === void 0 ? void 0 : _h.host, protocol: segmentLoadOptions === null || segmentLoadOptions === void 0 ? void 0 : segmentLoadOptions.protocol }));
