...
exports.timezoneOptions = exports.validateMonthDays = exports.validateWeekDays = exports.validateHours = exports.DAY_HOURS = exports.MONTH_DAYS = exports.WEEK_DAYS = void 0;
exports.WEEK_DAYS = [
    'Sunday',
    'Monday',
    'Tuesday',
...
exports.MONTH_DAYS = [...Array(31).keys()];
...
function validateMonthDays(days) {
    if (!Number.isInteger(days)) {
        return 0;
    }
...
exports.validateMonthDays = validateMonthDays;
