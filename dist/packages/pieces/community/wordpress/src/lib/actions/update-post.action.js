...
exports.updateWordPressPost = void 0;
...
const __1 = require("../..");
exports.updateWordPressPost = (0, pieces_framework_1.createAction)({
    auth: __1.wordpressAuth,
    name: 'update_post',
    description: 'Update an existing post on WordPress.',
    displayName: 'Update Post',
    props: {
        post: common_1.wordpressCommon.post,
    ...
    run(context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield pieces_common_1.httpClient.sendRequest({
                method: pieces_common_1.HttpMethod.POST,
                url: `${context.auth.website_url.trim()}/wp-json/wp/v2/posts/${context.propsValue.post}`,
                authentication: {
                    type: pieces_common_1.AuthenticationType.BASIC,
                    username: context.auth.username,
                    password: context.auth.password,
...
//# sourceMappingURL=update-post.action.js.map